...
class ScenarioMatricule_02  extends  Simulation{
  ...
  val FichierPath: String = System.getProperty("dataDir", "./src/test/resources/data/")
  ...
  def Get_scenario1_apppelfrequents_temporality(): ChainBuilder = {
  ...
  def Get_scenario1_apppelfrequents_today(): ChainBuilder = {
  ...
  def Get_scenario1_apppelfrequents_yesterday(): ChainBuilder = {
  ...
  def Get_scenario1_apppelfrequents_week(): ChainBuilder = {
  ...
  def Get_scenario1_apppelfrequents_month(): ChainBuilder = {
  ...
  val scenarioMatricule  = scenario("TEST_PERF_POPREM")
    ...
    .pause(5)
    .exec(Get_scenario1_apppelfrequents_temporality())
    .pause(5)
    .exec(Get_scenario1_apppelfrequents_today())
    .pause(5)
    .exec(Get_scenario1_apppelfrequents_yesterday())
    .pause(5)
    .exec( Get_scenario1_apppelfrequents_week())
    .pause(5)
    .exec(Get_scenario1_apppelfrequents_month())

  setUp(
    scenarioMatricule.inject(rampUsers(nbVu) during (TpsMonteEnCharge minutes),
      nothingFor(  TpsPalier minutes), rampUsers( nbVu ) during ( TpsMonteEnCharge minutes),
      nothingFor(  TpsPalier minutes), rampUsers( nbVu ) during ( TpsMonteEnCharge minutes),
      nothingFor(  TpsPalier minutes), rampUsers( nbVu ) during ( TpsMonteEnCharge minutes),
      nothingFor(  TpsPalier minutes), rampUsers( nbVu ) during ( TpsMonteEnCharge minutes),
      nothingFor(  TpsPalier minutes), rampUsers( nbVu ) during ( TpsMonteEnCharge minutes),
